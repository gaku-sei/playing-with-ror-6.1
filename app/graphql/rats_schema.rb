class RatsSchema < GraphQL::Schema
  ...
  rescue_from ActiveRecord::RecordInvalid do |err, _obj, _args, ctx, _field|
    err.record.errors.full_messages.each do |message|
      ctx.add_error GraphQL::ExecutionError.new(message, extensions: { 'code' => 'BAD_INPUT' })
    end
